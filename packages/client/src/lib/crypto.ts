/**
 * Client-side crypto utilities using tweetnacl + Web Crypto API.
 * This file is browser-only. All functions use:
 *   - nacl (tweetnacl) for X25519 + XSalsa20-Poly1305 operations
 *   - crypto.subtle (Web Crypto API) for PBKDF2 + AES-GCM key wrapping
 */
...
/**
 * Generate a random symmetric channel key.
 */
...
/**
 * Decrypt a channel key encrypted with encryptChannelKey.
 */
